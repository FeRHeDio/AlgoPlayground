...
/*
    ** Prompt **
    ...
    Each job will take a full day to complete, and the deadline will be given as the numbers of days left 
    to complete the job.
    ...
    Note: There is no requirement to complete all of the jobs. Only one job can be worked on at a time, meaning 
    that in some
