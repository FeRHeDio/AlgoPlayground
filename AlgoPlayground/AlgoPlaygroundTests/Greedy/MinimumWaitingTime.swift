...
/*
    ** Prompt **
    ...
    For example, if your're given the queries of durations [1, 4, 5], then the total waiting time 
    if the queries were
    ...
    the second query of duration 1
    would have to wait 5 seconds (the duration of the first query) to be exectuted, and the last 
    query would have to wait the
